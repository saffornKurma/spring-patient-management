...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        //vpc for (virtual private cloud for DBs
        ...
        FargateService authService=createFargateService("AuthService","auth-service",
                List.of(4005),authServiceDb,
                        Map.of("JWT_SECRET","hellomylovelyladyhowareyouwhoareyoukannadabarodilva"));

        //connect that it will use
    ...
    private CfnHealthCheck createDbHealthCheck(DatabaseInstance db, String id)
    {
        return CfnHealthCheck.Builder.create(this,id)
                ...
                .ipAddress(db.getDbInstanceEndpointAddress()).requestInterval(30)
                        .failureThreshold(3)
                        .build())
                .build();
    }
    ...
    //creating the each ECS Service like patient_service so necessasy things needs to be provided if db required and ports
    ...
    public static void main(final String[] args)
    {
        ...
        app.synth();
        System.out.println("App is ready and synthesising...");
    }
}
